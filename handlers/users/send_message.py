...
@dp.message_handler(Command('mg'), user_id=admins, state=Starting.choose)
...
@dp.message_handler(user_id=admins, state=Sending.user_id)
...
@dp.message_handler(user_id=admins, state=Sending.text)
...
@dp.message_handler(user_id=admins, state=Sending.confirm)
